...
/*
 *****************************************************************************
 * 函 数 名  : HTTPAPI_CreateHandle
 * 功能描述  : 创建http crul easy handle
 * 输入参数  : pstHttpHandleConfig, userInfo 
 *                            
 * 输出参数  : handle
 * 返 回 值  : EN_HTTP_ERRORCODE
 * 其它说明  : 
 ...
 * 输出参数  : 无
 * 返 回 值  : EN_HTTP_ERRORCODE
 * 其它说明  : 设置文件模式，在文件上传、文件下载接口调用前设置，确定文件传输时打开文件的模式
 * 
 * 修改历史      :
 *  1.日    期   : 2015年03月03日
 *    作    者   : l00287668
 ...
 * 输出参数  : 无
 * 返 回 值  : EN_HTTP_ERRORCODE
 * 其它说明  : 设置下载方式，是否支持断点下载，支持的话，主动取消的时候不删除原来已经下载的文件
 * 
 * 修改历史      :
 *  1.日    期   : 2015年03月24日
 *    作    者   : y00214372
...
/*
 *****************************************************************************
 * 函 数 名  : HTTPAPI_SetCurlNotRepoint
 * 功能描述  : 设置重定向是否透传到offline层
 * 输入参数  : handle  
 *             bCurlNotRepoint 
 ...
 * 输出参数  : 无
 * 返 回 值  : EN_HTTP_ERRORCODE
 * 其它说明  : bCurlNotRepoint 1 表示透传到上层， 0表示不透传到上层
 * 
 * 修改历史      :
 *  1.日    期   : 2015年03月24日
 *    作    者   : y00214372
...
/*
 *****************************************************************************
 * 函 数 名  : HTTPAPI_SetPartFileLength
 * 功能描述  : 设置分片传输文件的大小
 * 输入参数  : handle  
 *             iPartFileLength 
 ...
 * 输出参数  : 无
 * 返 回 值  : EN_HTTP_ERRORCODE
 * 其它说明  : bStartCurlLog 1表示开启  0 表示不开启
 * 
 * 修改历史      :
 *  1.日    期   : 2015年03月24日
 *    作    者   : y00214372
